...
window.onload=function(){
	...
	var arrCheckImg = Array("img2/0.jpg","img2/1.jpg","img2/2.jpg","img2/3.jpg","img2/4.jpg","img2/5.jpg","img2/6.jpg","img2/7.jpg","img2/8.jpg","img2/9.jpg",)
	var flag = 0;
	...
	kj("#user").onblur=function(){
		if(this.value.length<2){
			kj("span")[0].innerHTML="用户名不能小于8个字符！";
...
// 获取4位验证码
	...
	// 刷新验证码
	kj(".idCodeVal")[0].onclick=testCode;
